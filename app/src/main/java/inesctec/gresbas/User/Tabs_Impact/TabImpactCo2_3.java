...
public class TabImpactCo2_3 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.tabimpactco2, container, false);
    ...
    private void setImpact(String username, String beginDate, String endDate, String userpass, final BarChart barChart) {
        ...
        Call<ImpactData> call = gameClient.getImpact("1", beginDate, endDate, authHeader);  // 1 => CO2 data
        call.enqueue(new Callback<ImpactData>() {
            ...
            public void onResponse(Call<ImpactData> call, retrofit2.Response<ImpactData> response) {
                ...
                Bardataset = new BarDataSet(BARENTRY, "CO2 emissions");
