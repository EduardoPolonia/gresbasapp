...
public class TabImpactMoney1 extends Fragment {
    ...
    Switch switch_month_week;

    @Nullable
    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {
        final View rootView = inflater.inflate(R.layout.tabimpactmoney, container, false);
    ...
    private void setImpact(String username, String beginDate, String endDate, String userpass, final BarChart barChart) {
        ...
        Call<ImpactData> call = gameClient.getImpact("3", beginDate, endDate, authHeader);  // 3 => Money data
        call.enqueue(new Callback<ImpactData>() {
            ...
            public void onResponse(Call<ImpactData> call, retrofit2.Response<ImpactData> response) {
                ...
                Bardataset = new BarDataSet(BARENTRY, "Money");
