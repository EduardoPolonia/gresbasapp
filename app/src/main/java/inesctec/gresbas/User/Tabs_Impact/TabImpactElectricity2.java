...
public class TabImpactElectricity2 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.tabimpactelectricity, container, false);
    ...
    private void setImpact(String username, String beginDate, String endDate, String userpass, final BarChart barChart) {
        ...
        Call<ImpactData> call = gameClient.getImpact("2", beginDate, endDate, authHeader);  // 2 => Electricity data
        call.enqueue(new Callback<ImpactData>() {
            ...
            public void onResponse(Call<ImpactData> call, retrofit2.Response<ImpactData> response) {
                ...
                Bardataset = new BarDataSet(BARENTRY, "Electricity");
